    ...
    <Modal transparent animationType="slide" onRequestClose={onClose}>
      ...
      <View style={styles.sheetContainer}>
        <BlurView intensity={55} tint="dark" style={styles.sheet}>
          ...
          <Text style={styles.subtitle}>AI 拆解 · 专属微动作清单</Text>

          {task.bartender_comment ? (
            <View style={styles.commentBubble}>
              <Text style={styles.commentText}>💬 {task.bartender_comment}</Text>
            </View>
          ) : null}
              ...
              >
                ...
                <View style={styles.actionContent}>
                  ...
                  <View style={styles.actionMeta}>
                    {action.duration ? (
                      <Text style={styles.metaChip}>⏱ {action.duration}</Text>
                    ) : null}
                    {action.sensory_tip ? (
                      <Text style={styles.metaChip}>✦ {action.sensory_tip}</Text>
                    ) : null}
                  </View>
                </View>
              </TouchableOpacity>
